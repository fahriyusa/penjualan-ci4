 <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        <div class="container">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="<?php echo base_url().'welcome'?>">GF grocery store</a>
            </div>
                   ...
                   <?php $h=$this->session->userdata('akses'); ?>
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu"> 
                            <li><a href="<?php echo base_url().'admin/penjualan_grosir'?>"><span class="fa fa-cubes" aria-hidden="true"></span> Kasir</a></li> 
                        </ul>
                    </li>
                    <!--ending dropdown-->
                    <li>
                    ...
                    <li class="dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false" title="Transaksi"><span class="fa fa-shopping-cart" aria-hidden="true"></span> Transaksi</a>
                        <ul class="dropdown-menu">
                            <li><a href="<?php echo base_url().'admin/pelanggan'?>"><span class="fa fa-cubes" aria-hidden="true"></span> Kasir</a></li> 
                        </ul>
                    </li>
                    <li>
